  ...
  "rounded-2xl border text-card-foreground transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        premium: "bg-card border-border/30 shadow-lg hover:shadow-xl hover:-translate-y-1",
        glass: "backdrop-blur-xl bg-white/70 border border-white/20",
        elevated: "bg-card border-border/50 shadow-lg",
        interactive: "bg-card border-border/50 shadow-md hover:shadow-lg hover:border-primary/30 cursor-pointer",
        health: "bg-card border-border/30 shadow-lg",
